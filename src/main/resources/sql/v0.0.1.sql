...
CREATE SEQUENCE public.utem_users_id_seq
    MINVALUE 0
    NO MAXVALUE
    START 0
    NO CYCLE;
...
(
    appliant_user            int8                                                                                                                     NULL,
    application_request_date timestamp(6)                                                                                                             NULL,
    created_at               timestamp(6)                                                                                                             NOT NULL,
    id                       int8 GENERATED BY DEFAULT AS IDENTITY ( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
    offer                    int8                                                                                                                     NULL,
    updated_at               timestamp(6)                                                                                                             NOT NULL,
    application_status       public."offerapplicationstatus"                                                                                          NULL,
